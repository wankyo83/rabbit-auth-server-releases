...
public final class AppUpdaterReleaseValidationTest {
    ...
    @Test public void acceptsRepositoryReleaseApk() {
        AppUpdater.validateRelease(new AppUpdater.ReleaseInfo(
            "0.3.0-test9",
            13,
            "RabbitAuthServer-Android-0.3.0-test9.apk",
            "https://github.com/wankyo83/rabbit-auth-server-releases/releases/download/android-v0.3.0-test9/RabbitAuthServer-Android-0.3.0-test9.apk",
            HASH
        ));
    }
