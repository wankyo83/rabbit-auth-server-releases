...
public final class AppUpdaterReleaseValidationTest {
    ...
    @Test public void acceptsRepositoryReleaseApk() {
        AppUpdater.validateRelease(new AppUpdater.ReleaseInfo(
            "0.3.0-test6",
            10,
            "RabbitAuthServer-Android-0.3.0-test6.apk",
            "https://github.com/wankyo83/rabbit-auth-server-releases/releases/download/android-v0.3.0-test6/RabbitAuthServer-Android-0.3.0-test6.apk",
            HASH
        ));
    }
    ...
    @Test public void rejectsNonHttpsDownload() {
        assertThrows(IllegalArgumentException.class, () -> AppUpdater.validateRelease(new AppUpdater.ReleaseInfo(
            ...
            10,
            "RabbitAuthServer-Android-0.3.0-test6.apk",
            "http://github.com/wankyo83/rabbit-auth-server-releases/releases/download/android-v0.3.0-test6/RabbitAuthServer-Android-0.3.0-test6.apk",
            HASH
        )));
    }
    ...
    @Test public void rejectsAnotherRepository() {
        assertThrows(IllegalArgumentException.class, () -> AppUpdater.validateRelease(new AppUpdater.ReleaseInfo(
            ...
            10,
            "RabbitAuthServer-Android-0.3.0-test6.apk",
            "https://github.com/someone/else/releases/download/v1/RabbitAuthServer-Android-0.3.0-test6.apk",
            HASH
        )));
    }
