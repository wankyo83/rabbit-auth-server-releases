...
public final class ImagePageAccumulatorTest {
    ...
    @Test public void buildsBlacktoonCandidatesFromRelativeViewerPath() {
        assertEquals(
            List.of(
                "https://images-a.example/2026/09/01/%5Bfolder%5D/001.jpg",
                "https://images-b.example/2026/09/01/%5Bfolder%5D/001.jpg"
            ),
            WebAuthEngine.blacktoonPathCandidates(
                "/2026/09/01/[folder]/001.jpg",
                "https://images-a.example/",
                "https://images-b.example/"
            )
        );
    ...
    @Test public void rejectsProtocolRelativeBlacktoonViewerPath() {
        assertEquals(
            List.of(),
            WebAuthEngine.blacktoonPathCandidates(
                "//unexpected.example/001.jpg",
                "https://images-a.example/",
                "https://images-b.example/"
            )
        );
